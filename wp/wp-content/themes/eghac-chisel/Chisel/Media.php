...
class Media {
	...
	public function addImagesSizes() {
		add_image_size( 'small-thumbnail', 280, 240, true );
		add_image_size( 'large-thumbnail', 433, 240, true );
		add_image_size( 'page-image', 1920, 768, true );
		add_image_size( 'pinned-thumbnail', 889, 400, true );
		add_image_size( 'video-thumbnail', 888, 500, true );
